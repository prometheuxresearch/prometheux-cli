...
def _validate_project(root: Path, proj_dir: Path, report: Report) -> None:
    ...
    _validate_concepts(root, concepts_dir, datasource_names, report)
...
def _validate_concepts(root: Path, concepts_dir: Path, datasource_names: set, report: Report) -> None:
